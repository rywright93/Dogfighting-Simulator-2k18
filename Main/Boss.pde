...
class Boss
{
  ...
  public void shoot()
  {
    projectiles.add(new Projectile(xPos, yPos + bossHeight, 0, 400, "Enemy", color(0,0,255)));
    projectiles.add(new Projectile(xPos + bossWidth, yPos + bossHeight, 0, 400, "Enemy", color(0,0,255)));
  }
